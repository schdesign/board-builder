...
enum ToolButton
{
    ...
    PLACE_FEMALE_CONNECTOR, PLACE_GROUND, PLACE_GROUND_IEC, PLACE_INDUCTOR,
    PLACE_JUNCTION, PLACE_LED, PLACE_MALE_CONNECTOR, PLACE_NET_NAME,
    ...
    PLACE_SWITCH, PLACE_WIRE, PLACE_ZENER, SELECT,
