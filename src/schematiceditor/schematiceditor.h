...
static constexpr int maxButton = 56;
...
enum ToolButton
{
    ...
    PLACE_N_JFET, PLACE_N_MOSFET, PLACE_N_MOSFET_TETRODE, PLACE_NO_CONNECTION,
    PLACE_NPN_TRANSISTOR, PLACE_PHOTODIODE, PLACE_P_JFET, PLACE_P_MOSFET,
    ...
    PLACE_WIRE, PLACE_ZENER, SELECT, SELECT_PACKAGES, SET_VALUE, SHOW_NET_NUMBERS,
    TURN_TO_LEFT, TURN_TO_RIGHT, UPDATE_NETS
};
...
constexpr int elementType[maxButton] =
{
    ...
    CELL, CORE_INDUCTOR, 0, DIODE, 0, 0, 0, 0, 0, INDUCTOR, 0, LED, 0, 0, N_JFET,
    N_MOSFET, N_MOSFET_TETRODE, 0, NPN_TRANSISTOR, PHOTODIODE, P_JFET, P_MOSFET,
    PNP_TRANSISTOR, POLAR_CAPACITOR, 0, QUARTZ, RESISTOR_ANSI, RESISTOR_IEC,
    SCHOTTKY, 0, 0, ZENER, 0, 0, 0, 0, 0, 0
};
