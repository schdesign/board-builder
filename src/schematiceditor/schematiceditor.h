...
static constexpr int maxButton = 59;
...
enum ToolButton
{
    ...
    PLACE_DOUBLE_SCHOTTKY, PLACE_FEMALE_CONNECTOR, PLACE_FUSE, PLACE_GROUND,
    PLACE_GROUND_IEC, PLACE_INDUCTOR, PLACE_JUNCTION, PLACE_LED, PLACE_MALE_CONNECTOR,
    PLACE_NET_NAME, PLACE_N_JFET, PLACE_N_MOSFET, PLACE_N_MOSFET_TETRODE,
    PLACE_NO_CONNECTION, PLACE_NPN_TRANSISTOR, PLACE_PHOTODIODE, PLACE_P_JFET,
    PLACE_P_MOSFET, PLACE_PNP_TRANSISTOR, PLACE_POLAR_CAPACITOR, PLACE_POWER,
    PLACE_QUARTZ, PLACE_RESISTOR_ANSI, PLACE_RESISTOR_IEC, PLACE_SCHOTTKY, PLACE_SWITCH,
    PLACE_THYRISTOR, PLACE_TRIAC, PLACE_WIRE, PLACE_ZENER, SELECT, SELECT_PACKAGES,
    SET_VALUE, SHOW_NET_NUMBERS, TURN_TO_LEFT, TURN_TO_RIGHT, UPDATE_NETS
};
...
constexpr int elementType[maxButton] =
{
    ...
    CELL, CORE_INDUCTOR, 0, DIODE, 0, 0, 0, FUSE, 0, 0, INDUCTOR, 0, LED, 0, 0,
    N_JFET, N_MOSFET, N_MOSFET_TETRODE, 0, NPN_TRANSISTOR, PHOTODIODE, P_JFET,
    P_MOSFET, PNP_TRANSISTOR, POLAR_CAPACITOR, 0, QUARTZ, RESISTOR_ANSI,
    RESISTOR_IEC, SCHOTTKY, 0, THYRISTOR, TRIAC, 0, ZENER, 0, 0, 0, 0, 0, 0
};
