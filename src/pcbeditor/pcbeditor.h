...
class PcbEditor : public QMainWindow, private Ui::PcbEditor
{
    ...
    constexpr static int toolButtons = 35;
    ...
    enum ToolButton
    {
        CREATE_GROUPS, DECREASE_STEP, DELETE, DELETE_JUNCTION, DELETE_NET_SEGMENTS,
        DELETE_POLYGON, DELETE_SEGMENT, FILL_POLYGON, INCREASE_STEP, METER, MOVE,
        MOVE_DOWN, MOVE_GROUP, MOVE_LEFT, MOVE_RIGHT, MOVE_UP, NO_ROUND_TURN,
        PLACE_ELEMENTS, PLACE_JUNCTION, PLACE_LINE, PLACE_POLYGON, PLACE_SEGMENT,
