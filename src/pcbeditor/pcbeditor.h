...
class PcbEditor : public QMainWindow, private Ui::PcbEditor
{
    ...
    static constexpr int toolButtons = 40;
    ...
    enum ToolButton
    {
        CONNECT_JUMPER, CONNECT_PAD, CREATE_GROUPS, DECREASE_STEP, DELETE,
        DELETE_JUMPER, DELETE_NET_SEGMENTS, DELETE_POLYGON, DELETE_SEGMENT,
        DELETE_VIA, DISCONNECT_JUMPER, FILL_POLYGON, INCREASE_STEP, METER, MOVE,
        MOVE_DOWN, MOVE_GROUP, MOVE_LEFT, MOVE_RIGHT, MOVE_UP, NO_ROUND_TURN,
        PLACE_ELEMENTS, PLACE_JUMPER, PLACE_LINE, PLACE_POLYGON, PLACE_SEGMENT,
        PLACE_VIA, ROUND_TURN, ROUTE_TRACKS, SEGMENT_NETS, SELECT, SET_VALUE,
        SHOW_GROUND_NETS, TABLE_ROUTE, TURN_TO_LEFT, TURN_TO_RIGHT, UPDATE_NETS,
        WAVE_ROUTE, ZOOM_IN, ZOOM_OUT
    };
